...
最終更新: 2026-04-28（file inspector + tag/notes 編集 landed: Tauri `tag_add` / `tag_remove` / `notes_read` / `notes_write` + `<FileInspector>` + selection union lift + `<ResultDetailDialog>` 撤去）
